...
exports.createPatient = async (req, res) => {
    try {
        ...
        const { nom, prenom, age, poids, taille, traitement_en_cours, medicament, medecin, notes, rdv, statut, numero_de_telephone,mail } = req.body;
...
exports.updatePatient = async (req, res) => {
    try {
        ...
        const result = await pool.query(
            `UPDATE "Patients" 
            SET nom = $1, prenom = $2, age = $3, poids = $4, taille = $5, traitement_en_cours = $6, medicament = $7, medecin = $8, notes = $9, rdv = $10, statut = $11, numero_de_telephone = $12 , mail = $13
            WHERE id = $14 RETURNING *`,
            [nom, prenom, age, poids, taille, traitement_en_cours, medicament, medecin, notes, rdv, statut, numero_de_telephone, id, mail]
        );
